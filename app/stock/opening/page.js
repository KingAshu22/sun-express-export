  ...
  return (
    <Layout>
      <div className="space-y-6">
        <div>
          <h1 className="text-3xl font-bold">Opening Stock</h1>
          <p className="text-gray-600">Add opening stock with invoice details</p>
        </div>
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <Button type="submit" className="w-full" disabled={loading}>
                {loading ? "Please wait..." : "Add Opening Stock"}
              </Button>
            </form>
          </CardContent>
        </Card>
